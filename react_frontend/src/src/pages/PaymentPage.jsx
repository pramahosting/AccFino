...
export default function PaymentPage() {
  ...
  const selectedLabel = () => {
    ...
    if (!selKeys.length) return plans.base?.name || 'Free'
  ...
  const leftPlans = [
    { name: plans.base?.name || 'Free', price: plans.base?.price_monthly === 0 ? 'Free' : `$${(plans.base?.price_monthly||0)/100}/mo`, desc: plans.base?.description || '' },
